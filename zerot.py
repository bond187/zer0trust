...
def packet_list(read_file):
  ...
  be network traffic for each packet, and one source mac and destination mac, which have relationships to many network traffic objects.
  '''
  ...
  print("Unique sources: {}, Unique destinations: {}".format(len(unique_srcs), len(unique_dsts)))
